    ...
    <div className="min-h-screen px-6 pt-22 pb-10">
      <div className="max-w-4xl mx-auto animate-fade-in">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gray-900/50 p-8 rounded-lg border border-gray-800 hover:border-blue-500 transition-colors">
          ...
          <div className="bg-gray-900/50 p-8 rounded-lg border border-gray-800 hover:border-green-500 transition-colors">
        ...
        {/* Social Links */}
        <div className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 p-8 rounded-lg border border-gray-800">
